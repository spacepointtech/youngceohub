  ...
  return (
    ...
    <h1 className="text-4xl font-bold text-white mb-8">Audience</h1>
          ...
          <div className="flex justify-start items-center mb-8 relative">
            ...
            <Link href="/dashboard/segements" className="relative text-white font-bold mx-4 after:content-[''] after:absolute after:left-0 after:bottom-[-2px] after:h-[2px] after:bg-white after:w-[100%]">
              Segments
            </Link>
            <Link href="#" className="text-white opacity-50 mx-4">
              Location
            </Link>
        ...
        <section className="bg-[#1A1A1A] p-6 rounded-lg shadow-lg w-[75%] mb-8 relative min-h-[700px]"> {/* Adjust the height */}
  <div
    className="absolute inset-0 bg-cover bg-center rounded-lg"
    style={{ backgroundImage: "url('/images/segments.png')" }}
  />
</section>
