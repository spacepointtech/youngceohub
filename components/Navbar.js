...
//         {/* Toggle Menu Box */}
//         {isOpen && (
//           <div className="sm:hidden fixed top-full left-0 right-0 bg-black bg-opacity-50 py-2 px-4 text-white z-20">
//             <div className="py-2">
//               <Link href="/" className="block py-2 hover:text-gray-400">Home</Link>
//             </div>
//             <div className="py-2">
//               <Link href="/music" className="block py-2 hover:text-gray-400">Music Distribution</Link>
//             </div>
//             <div className="py-2">
//               <Link href="/team" className="block py-2 hover:text-gray-400">Our Team</Link>
//             </div>
//             <div className="py-2">
//               <Link href="/support" className="block py-2 hover:text-gray-400">Support</Link>
//             </div>
//             <div className="py-2">
//               <Link href="/contact" className="block py-2 hover:text-gray-400">Contact us</Link>
//             </div>
//           </div>
//         )}
//       </div>
